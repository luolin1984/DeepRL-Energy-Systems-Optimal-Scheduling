...
class Arguments:
    ...
    def __init__(self, agent=None, env=None):
        ...
        self.plot_shadow_on = True# control do we need to plot all shadow figures
        ...
        self.batch_size = 4096  # num of transitions sampled from replay buffer. 4096
        self.repeat_times = 2 ** 3  # repeatedly update network to keep critic's loss small
        self.target_step = 1024 # collect target_step experiences , then update network, 1024, 4096
        self.max_memo = 50000  # capacity of replay buffer 500000
